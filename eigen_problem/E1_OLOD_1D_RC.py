...
root = 'All_Data/OO_1D_randcheck/test_folder/' #provide a path/folder for the data to be saved, e.g. test_folder
...
plots_cvg(root=root, H_Convergence=True, p_Convergence=True, dim=1)